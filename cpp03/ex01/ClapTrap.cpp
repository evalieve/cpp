...
void ClapTrap::attack(const std::string& target) {
	...
	std::cout << "ClapTrap " << BLU << this->_name << NC << " attacks " << YEL << target << NC <<" causing it to lose " << RED << this->_AD << NC << " hit points!" << std::endl;
	std::cout << "ClapTrap " << BLU << this->_name << NC << " has " << RED << this->_EP << NC << " energy points left" << std::endl;
}
